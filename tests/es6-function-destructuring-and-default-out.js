...
function test5() {var a = arguments[0];if(a === void 0)a = 1;var b = arguments[1];if(b === void 0)b = {c: 333};var test = (arguments[2] !== void 0 ? arguments[2] : (function($D$1) {function ITER$0(v,f){if(v){if(Array.isArray(v))return f?v.slice():v;var i,r;if(typeof v==='object'&&typeof v['@@iterator']==='function'){i=v['@@iterator'](),r=[];while((f=i['next']()),f['done']!==true)r.push(f['value']);return r;}}throw new Error(v+' is not iterable')};var A = $D$1.A;return (A = [].concat(ITER$0(A, true), ITER$0(A)) , {test: A} )})({A: [1, 2, 3]})).test;
