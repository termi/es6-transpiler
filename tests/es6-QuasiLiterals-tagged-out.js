...
var filter = void 0;
function test(quasis){var ARRAY$0 = Array;for (var l$0 = arguments.length, expressionValues = ARRAY$0(l$0 > 1 ? l$0 - 1 : 0),  i$0 = 1; i$0 < l$0; i$0++) expressionValues[i$0 - 1] = arguments[i$0];
	var raw = quasis.raw;
