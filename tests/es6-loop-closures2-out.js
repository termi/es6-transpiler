function GET_ITER$0(v){if(v){if(Array.isArray(v))return 0;if(typeof v==='object'&&typeof v['@@iterator']==='function')return v['@@iterator']();}throw new Error(v+' is not iterable')};var $D$0;var $D$1;var $D$2;var $D$6;"use strict";
...
res = (function() {;var $that$0=this;
    label: for (var x = 0; x < 3; x++) {;var $retPrim$0;var $retVoid$0;var $break$0;var $breaklabel$0;;var $retVal$0, $value$0 = (function(){
        var y = x;
...
// var's inside scoped block should work as a regular var's regardless of whether or not block wrapper by IIFE
{
    arr = [];
    var a = [1, 2, 3, 4, 5];
    $D$0 = GET_ITER$0(a);$D$1 = $D$0 === 0;$D$2 = ($D$1 ? a.length : void 0);for( var x$0 ; $D$1 ? ($D$0 < $D$2) : !($D$2 = $D$0["next"]())["done"]; ){x$0 = ($D$1 ? a[$D$0++] : $D$2["value"]);;var j, k, c, d, e, GG;var $break$0;(function(x){
    ...
    })(x$0);if($break$0===true){$break$0=void 0;break }};$D$0 = $D$1 = $D$2 = void 0;
...
// this test
arr = (function() {;var $that$0=this;;var $that$0=this;;var $args$0=arguments;var this$0 = this;'use strict';var arr = [];
...
arr = [];
res = (function(){var $D$3;var $D$4;var $D$5;;var $args$0=arguments;
    var a = [1, 2, 3, 4, 5];
    $D$3 = GET_ITER$0(a);$D$4 = $D$3 === 0;$D$5 = ($D$4 ? a.length : void 0);for( var x ; $D$4 ? ($D$3 < $D$5) : !($D$5 = $D$3["next"]())["done"]; ){x = ($D$4 ? a[$D$3++] : $D$5["value"]);;var $break$0;;var $retVal$0, $value$0 = (function(x){
        arr.push(function(){ return x });
        if(x==1)return;
        if(x==2&&false){$break$0 = true;return}
        if(x==3){$retVal$0 = true;return $args$0[2];}
    })(x);if($break$0===true){$break$0=void 0;break }if($retVal$0===true){try{throw $value$0 }catch($rp$0){$value$0=$retVal$0=void 0;return $rp$0}}};$D$3 = $D$4 = $D$5 = void 0;
})(9, 8, 7);
console.log(arr.map(call).join("|") == [1, 2, 3].join("|"), res == 7);

// continue is not allowed inside the loop body because the IIFE would break it
arr = [];
$D$6 = ([1, 2, 3, 4, 5]);$D$0 = GET_ITER$0($D$6);$D$1 = $D$0 === 0;$D$2 = ($D$1 ? $D$6.length : void 0);for( var x22 ; $D$1 ? ($D$0 < $D$2) : !($D$2 = $D$0["next"]())["done"]; ){x22 = ($D$1 ? $D$6[$D$0++] : $D$2["value"]);(function(){
    var y = x22, z = 55;
    arr.push(function(){ return y });
    return;
})();};$D$0 = $D$1 = $D$2 = $D$6 = void 0;
console.log(arr.map(call).join("|") == [1, 2, 3, 4, 5].join("|"));

// continue + forOf + destructuring
arr = [];var random__ = Math.random();
$D$6 = ([{a: {x: 1, y: 2, z: 3}}]);$D$0 = GET_ITER$0($D$6);$D$1 = $D$0 === 0;$D$2 = ($D$1 ? $D$6.length : void 0);for( var x11 ; $D$1 ? ($D$0 < $D$2) : !($D$2 = $D$0["next"]())["done"]; ){x11 = ($D$1 ? $D$6[$D$0++] : $D$2["value"]);(function(){
...
{// break + forOf + destructuring
    arr = [];
    var x$2, y, z;$D$6 = ([{x:1,y:0}, {x:1,y:1}, {x:1,y:2}]);$D$0 = GET_ITER$0($D$6);$D$1 = $D$0 === 0;$D$2 = ($D$1 ? $D$6.length : void 0);for(  ; $D$1 ? ($D$0 < $D$2) : !($D$2 = $D$0["next"]())["done"]; ){;x$2 = (z = ($D$1 ? $D$6[$D$0++] : $D$2["value"])).x, y = z.y, z = z.z;;var $break$0;(function(x, y, z){
        arr.push(function(){ return x + y });
        {$break$0 = true;return}
    })(x$2, y, z);if($break$0===true){$break$0=void 0;break }};$D$0 = $D$1 = $D$2 = $D$6 = void 0;

    var x$3, y$0, z$0;$D$6 = ([{x:1,y:0}, {x:1,y:1}, {x:1,y:2}]);$D$0 = GET_ITER$0($D$6);$D$1 = $D$0 === 0;$D$2 = ($D$1 ? $D$6.length : void 0);for(  ; $D$1 ? ($D$0 < $D$2) : !($D$2 = $D$0["next"]())["done"]; ){;x$3 = (z$0 = ($D$1 ? $D$6[$D$0++] : $D$2["value"])).x, y$0 = z$0.y, z$0 = z$0.z;;var $break$0;(function(x, y, z){
        arr.push(function(){ return x + y + (z | 0) });
        if(y == 2){$break$0 = true;return}
    })(x$3, y$0, z$0);if($break$0===true){$break$0=void 0;break }};$D$0 = $D$1 = $D$2 = $D$6 = void 0;
