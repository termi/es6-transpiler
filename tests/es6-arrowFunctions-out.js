...
var obj = {
	a: 1,
	some: function(){for (var l$0 = arguments.length, rest = ARRAY$0(l$0), i$0 = 0; i$0 < l$0; i$0++) rest[i$0] = arguments[i$0];return rest.map(function(a){return a + 1})},
	b: 6
}
...

{
	...
	result = (function() {
		var obj = {
			test:"test",arr:function(){var a = arguments[0];if(a === void 0)a = 'String';for (var l$1 = arguments.length, rest = ARRAY$0(l$1 > 1 ? l$1 - 1 : 0),  i$1 = 1; i$1 < l$1; i$1++) rest[i$1 - 1] = arguments[i$1];var this$1 = this;return function(){return this$1.test+a+test$2+rest.join("")}},test2:1
		};
